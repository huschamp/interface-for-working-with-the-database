...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Connect to Data Base"))
        self.label.setText(_translate("Dialog", "DataBase_name"))
        self.lineEdit.setText(_translate("Dialog", "postgres"))
        self.label_2.setText(_translate("Dialog", "Server name"))
        self.lineEdit_2.setText(_translate("Dialog", "postgres"))
        self.label_3.setText(_translate("Dialog", "Password"))
        self.lineEdit_3.setText(_translate("Dialog", "123456"))
        self.label_4.setText(_translate("Dialog", "IP host"))
